...
namespace MissionPlanner.Controls
{
    public class MyButton : Button
    {
       ...
       public Color BGGradBot { get { return _BGGradBot; } set { _BGGradBot = value; this.Invalidate(); } }
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Colors")]
        [DefaultValue(typeof(Color), "28, 151, 234")]
        ...
        // i want to ignore forecolor
         ...
         [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Colors")]
         [DefaultValue(typeof(Color), "67, 67, 70")]
         public Color Outline { get { return _Outline; } set { _Outline = value; this.Invalidate(); } }

        public MyButton()
        {
            _BGGradTop = Color.FromArgb(51, 51, 55);
            _BGGradBot = Color.FromArgb(51, 51, 55);
            _TextColor = Color.FromArgb(255, 255, 255);
            _Outline = Color.FromArgb(67, 67, 70);
            _ColorNotEnabled = Color.FromArgb(51, 51, 55);
            _ColorMouseOver = Color.FromArgb(28, 151, 234);
            _ColorMouseDown = Color.FromArgb(28, 151, 234);
        }
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            try
            {
                ...
                // Right line
                outline.AddLine(width - wid, 0, width - wid, height - wid);
                // tr
                //outline.AddArc(width - wid, 0, wid, wid, 270, 90);
                // br
                //outline.AddArc(width - wid, height - wid, wid, wid, 0, 90);
                // bottom line
                outline.AddLine(width - wid, height, wid, height);
                // bl
